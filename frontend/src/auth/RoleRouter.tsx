...
import { KodaLogoSpinner, Spinner, TopProgressBar } from "../components/ui";
...
const Splash: React.FC = () => (
  <div className="flex min-h-screen w-full flex-col items-center justify-center gap-4 overflow-hidden bg-gradient-to-br from-indigo-50/80 via-white to-violet-50/80 p-4 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950">
    <TopProgressBar loading={true} />
    <KodaLogoSpinner size="xl" label="Getting things ready…" />
  </div>
);
