 ...
 *
 * Only the arithmetic components keep their presets here. The rest declare theirs inside their
 * own schema file, which is where a new component should put them: a shared list gives no
 * benefit when every entry has exactly one importer.
 */
