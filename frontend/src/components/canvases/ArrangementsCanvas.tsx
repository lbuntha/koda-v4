...
import { RotateCcw, LayoutGrid, Check, Calculator, AlertCircle, Delete } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <AnimatePresence>
          {answerPanelOpen && (
            /*
              Docked over the number track, never over the objects: the whole
              lesson is that the arrangement does not change the count, so the
              arrangement has to stay in view while the child answers.
            */
