...
const BADGE_CONFIG = {
  practice: {
    ...
    Icon: Target,
    badgeBg: "bg-[#FF6B00]",
    border: "border border-[#FFD2B8] dark:border-amber-500/30",
  ...
  completed: {
    ...
    Icon: CheckCircle2,
    badgeBg: "bg-[#00B862]",
    border: "border border-[#B8F0D0] dark:border-emerald-500/30",
  ...
  new: {
    ...
    Icon: Star,
    badgeBg: "bg-[#6346F1]",
    border: "border border-[#D0C5FF] dark:border-indigo-500/30",
