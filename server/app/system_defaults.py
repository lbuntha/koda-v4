...
DEFAULT_SETTINGS: list[dict] = [
    ...
    },
    {
        ...
        "description": "Tells a parent once when a child has been away longer than the threshold in Events.",
        "type": "bool",
        "value": True,
        "order": 87,
    },
    {
        ...
        "description": "Tells a parent when a child has used the day's time, once per child per day.",
        "type": "bool",
        "value": True,
        "order": 88,
    },
    {
        ...
        "description": "Tells a parent when a lesson becomes secure, at most once per child per day.",
        "type": "bool",
        "value": True,
        "order": 89,
    },
    {
        ...
        "description": "Tells a parent when a lesson keeps going wrong, at most once per lesson per week.",
        "type": "bool",
        "value": True,
        "order": 89,
    },
    {
        ...
        "group": "Notifications",
        "label": "Stuck emails",
        "description": "Emails a parent a tip when a lesson keeps going wrong, at most once per lesson per week.",
        "type": "bool",
        "value": True,
        "order": 96,
    },
    {
        ...
        "description": "One email per parent with the week of every child who practised.",
        "type": "bool",
        "value": True,
        "order": 92,
    },
    {
        ...
        "group": "Notifications",
        "label": "Absence emails",
        "description": "Emails a parent once when a child has been away longer than the threshold.",
        "type": "bool",
        "value": True,
        "order": 93,
    },
    {
        ...
        "description": "Allows the daily digest a parent can ask for. Every family starts with it off.",
        "type": "bool",
        "value": True,
        "order": 94,
    },
    {
        ...
        "group": "Notifications",
        "label": "New skill emails",
        "description": "Allows an email when a skill is published. Every family starts with it off.",
        "type": "bool",
        "value": True,
        "order": 95,
    },
