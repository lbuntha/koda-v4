...
export const RACK_SPECS: RackSpec[] = [
  ...
  { id: "four-colours", mode: "plain", colours: 4, bottles: 6, cap: 4, scramble: 13 },
  { id: "taller-bottles", mode: "plain", colours: 4, bottles: 6, cap: 5, scramble: 15 },
  { id: "one-space-left", mode: "plain", colours: 4, bottles: 5, cap: 4, scramble: 13 },
  { id: "no-free-bottle", mode: "plain", colours: 4, bottles: 5, cap: 4, scramble: 14 },
  { id: "the-locked-bottle", mode: "locked", colours: 3, bottles: 5, cap: 4, scramble: 10, lock: { tube: 4, on: 0 } },
  { id: "two-locks", mode: "locked", colours: 4, bottles: 6, cap: 4, scramble: 13, lock: { tube: 5, on: 0 } },
  { id: "the-one-way-bottle", mode: "oneway", colours: 3, bottles: 5, cap: 4, scramble: 11, oneWay: 3 },
  { id: "think-before-you-pour", mode: "budget", colours: 4, bottles: 6, cap: 4, scramble: 13, budget: "minimum+2" },
  { id: "the-shortest-way", mode: "budget", colours: 3, bottles: 5, cap: 4, scramble: 9, budget: "minimum" },
  { id: "practice-planning", mode: "plain", colours: 4, bottles: 6, cap: 4, scramble: 13 },

  { id: "what-is-underneath", mode: "hidden", colours: 3, bottles: 5, cap: 4, scramble: 11, hidden: true },
